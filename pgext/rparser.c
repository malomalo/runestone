 ...
 *
 * rparser.c
 *		Text search parser for Runestone
 *
 * Portions Copyright (c) 2021-2022, Jon Bracy
...
PG_FUNCTION_INFO_V1(rparser_start);
PG_FUNCTION_INFO_V1(rparser_nexttoken);
PG_FUNCTION_INFO_V1(rparser_end);
PG_FUNCTION_INFO_V1(rparser_lextype);
PG_FUNCTION_INFO_V1(rparser_headline);

/* Define me to enable tracing of parser behavior */
#define WPARSER_TRACE 1
...
static const TParserStateActionItem actionTPS_Base[] = {
	...
	{p_isnotspace, 0, A_NEXT, TPS_InSymbols, 0, NULL},
...
static const TParserStateActionItem actionTPS_InNumWord[] = {
	...
	{p_isnotspace, 0, A_NEXT, TPS_InWord, 0, NULL},
...
static const TParserStateActionItem actionTPS_InSpace[] = {
	...
	{p_iseqC, '&', A_BINGO, TPS_Base, SPACE, NULL},
	{p_iseqC, '/', A_BINGO, TPS_Base, SPACE, NULL},
	{p_isnotspace, 0, A_BINGO, TPS_Base, SPACE, NULL},
...
static const TParserStateActionItem actionTPS_InHyphenAsciiWord[] = {
	...
	{p_iseqC, '-', A_PUSH, TPS_InHyphenAsciiWordFirst, 0, NULL},
	{NULL, 0,  A_CLRALL, TPS_InParseHyphen, ASCIIHWORD, SpecialHyphen}
};
...
static const TParserStateActionItem actionTPS_InHyphenWord[] = {
	...
	{p_isdigit, 0, A_NEXT, TPS_InHyphenNumWord, 0, NULL},
	{p_iseqC, '-', A_PUSH, TPS_InHyphenWordFirst, 0, NULL},
	{NULL, 0, A_BINGO | A_POP, TPS_InParseHyphen, HWORD, SpecialHyphen}
};
...
static const TParserStateActionItem actionTPS_InHyphenAsciiWordPart[] = {
	...
	{p_isspecial, 0, A_NEXT, TPS_InHyphenWordPart, 0, NULL},
	{p_isdigit, 0, A_NEXT, TPS_InHyphenNumWordPart, 0, NULL},
	{p_isspace, 0, A_BINGO, TPS_Base, ASCIIPARTHWORD, NULL},
	{NULL, 0, A_NEXT, TPS_InParseHyphen, 0, NULL}
};
...
static const TParserStateActionItem actionTPS_InSymbols[] = {
	{p_isEOF, 			0, A_BINGO, TPS_Base, SYMBOL_T, NULL},
	// {p_isdigit, 0, A_NEXT, TPS_Null, 0, NULL},
	{p_isalpha, 0, A_NEXT, TPS_InWord, 0, NULL},
	// {p_isspecial, 0, A_CLEAR, TPS_InHyphenNumWordPart, 0, NULL},
	// {NULL, 0, A_POP, TPS_Null, 0, NULL}
	{p_isnotspace, 	0, A_NEXT, 	TPS_InSymbols, 0, NULL},
	{NULL, 					0, A_BINGO, TPS_Base, SYMBOL_T, NULL}
};
...
static const TParserStateAction Actions[] = {
	...
	TPARSERSTATEACTION(TPS_InSymbols),
};
...
Datum
rparser_lextype(PG_FUNCTION_ARGS)
{
 ...
 */
Datum
rparser_headline(PG_FUNCTION_ARGS)
{
